...
const createContractTx = async () => {
    ...
    //const wallet = new ethers.Wallet('2e6e9d2f3cfa14e6461ed109e8579b7358cec9c3cde20dfca819424ce3d1fb7d', provider);
    //const contractConnect = contract.connect(wallet);
    //const tx = await contractConnect.registerUser('0x1814727b5bE9286978c04EED5D64eAEAb00Fd145', 900);
