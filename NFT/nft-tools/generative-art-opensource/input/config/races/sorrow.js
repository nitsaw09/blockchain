            ...
            elements: [
              {
                id: 0,
                name: 'Eyes-3',
                path: `${dir}/2-Eyes/Eyes3.png`,
                weight: 15,
              },
              {
                id: 1,
                name: 'Eyes-5',
                path: `${dir}/2-Eyes/Eyes5.png`,
                weight: 12,
              },
              {
                id: 2,
                name: 'Eyes-6',
                path: `${dir}/2-Eyes/Eyes6.png`,
                weight: 10,
              },
            ],
            position: { x: 0, y: 0 },
            ...
            elements: [
              {
                id: 0,
                name: 'Mouth-1',
                path: `${dir}/4-Mouth/Mouth1.png`,
                weight: 70,
              },
              {
                id: 1,
                name: 'Mouth-5',
                path: `${dir}/4-Mouth/Mouth5.png`,
                weight: 20,
              },
              {
                id: 2,
                name: 'Mouth-6',
                path: `${dir}/4-Mouth/Mouth6.png`,
                weight: 10,
              },
            ],
            position: { x: 0, y: 0 },
